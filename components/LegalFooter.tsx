...
export default function LegalFooter() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-border bg-muted/50 backdrop-blur-sm">
      {/* Subtle animated background gradient */}
      <div className="absolute inset-0 opacity-[0.03]">
        <div
          className="absolute inset-0 animate-gradient-shift bg-gradient-to-br from-primary via-muted-foreground to-warning"
          style={{
      ...
      <div className="relative mx-auto w-full max-w-2xl px-4 pb-6 pt-4 lg:max-w-4xl">
        ...
        <div className="mb-4 rounded-lg border border-warning/30 bg-warning/10 p-3 backdrop-blur-sm transition-all hover:border-warning/50">
          <div className="flex items-start gap-3">
            {/* Animated warning icon */}
            <div className="relative mt-0.5 flex-shrink-0">
              <div className="absolute inset-0 animate-pulse rounded-full bg-warning/20" />
              <span
            ...
            <button
              ...
              className="group flex-shrink-0 rounded-md border border-border bg-muted/50 px-3 py-1.5 text-xs font-medium text-foreground transition-all hover:border-warning/50 hover:bg-warning/10 hover:text-foreground"
          ...
          >
            <div className="rounded-md border border-border bg-muted/50 p-3 text-[10px] leading-relaxed text-muted-foreground backdrop-blur-sm">
              <div className="space-y-2">
                ...
                <p>
                  <strong className="text-foreground">Privacidad de datos:</strong> No se
                  recopila, almacena ni transmite información de pacientes. Todos los
                  cálculos se realizan localmente en el navegador.
                </p>
                <p>
                  <strong className="text-foreground">Uso profesional:</strong> Esta herramienta
        ...
        {/* Copyright and Links */}
        <div className="flex flex-col items-center gap-2 border-t border-border pt-3 text-center text-[10px] text-muted-foreground xs:flex-row xs:justify-between">
